  ...
  return (
    <>
      <div className={`my-3 p-3 bg-slate-50 border border-slate-200 rounded-2xl ${containerClassName}`}>
        ...
        {/* Comprehensive Error State with Direct Workarounds */}
        {hasError && (
          <div className="p-4 bg-amber-50/80 border border-amber-200 rounded-xl space-y-3 text-xs">
                  ...
                  {isGdrive ? (
                    <>
                      ...
                      <span className="block mt-0.5 text-amber-700">
                        ※ Googleドライブで「共有」→ 一般的なアクセスを<strong>「リンクを知っている全員（閲覧者）」</strong>に変更してください。
                      </span>
                    </>
                  ) : (
            ...
            {/* Quick Workaround Action Buttons */}
        ...
        {/* Modal for full screen / zoom preview */}
      {isZoomOpen && (
        <div 
